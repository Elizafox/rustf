...
mod tests {
    ...
    fn hello_world() {
        ...
        assert_eq!(run_program(src, b"", 2), b"Hello World!\n");
    }
    ...
    fn rot13() {
        ...
        assert_eq!(run_program(src, b"hello", 2), b"uryyb");
        assert_eq!(run_program(src, b"uryyb", 2), b"hello");
    }
    ...
    #[test]
    fn optimizer_equivalence_rot13() {
        let src = concat!(
            ",[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<",
            "-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<",
            "-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<-[>+<",
        ...
        assert_eq!(
            run_program(src, b"hello world", 0),
            run_program(src, b"hello world", 2)
        );
    }
}
